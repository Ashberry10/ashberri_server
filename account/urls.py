...
urlpatterns = [
    ...
    # path('users/', GetAllUser.as_view(),name='getallusers'),# NOTE --this api can be use later on, instead of this api use http://127.0.0.1:8000/account/AllUserInfoWithFriendStatus/
    # path('users/<int:id>',GetAllUser.as_view(), ),#NOTE --this api can be use later on instead of this api use http://127.0.0.1:8000/account/UserByIdInfoWithFriendStatus/?id=1
