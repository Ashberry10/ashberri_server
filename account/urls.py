...
from account.views import AllUser, CommentPost, GetPostsById, LikePost, SharePost, UpdateUser, UserDeleteView, UserLoginView, UserProfileView,UserRegistrationView, CreatePost
...
urlpatterns = [
    ...
    path('post/<int:post_id>/',GetPostsById.as_view(), name='getPostById'),
